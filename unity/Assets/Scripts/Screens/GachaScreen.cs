...
namespace GameMaker.Screens
{
    ...
    public class GachaScreen : MonoBehaviour
    {
        ...
        void ShowRates()
        {
            ...
            Ui.Place(viewport, new Vector2(0.5f, 1f), new Vector2(-20, -110), new Vector2(960, 620));
            ...
            var vbar = Ui.CleanScrollbar(board, false, new Vector2(1f, 1f), new Vector2(-34, -110), new Vector2(16, 620));
